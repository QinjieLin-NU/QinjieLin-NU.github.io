...
[CV](./olds/data-qinjie/CV_QInjieLin-19.pdf) / 
...
2. **ICRA 2023** - EMS®: A Massive Computational Experiment Management System towards Data-driven Robotics  
   ...
   [paper](data-qinjie/ICRA2023.pdf) / [website](https://sites.google.com/view/project-emsr) / [code](https://github.com/emsr-project/emsr_examples) / [video](https://youtu.be/Nd0vzHnERss)
...
3. **CoRL 2021** - RoboFlow: a Data-centric Workflow Management System for Developing AI-enhanced Robots  
   ...
   [paper](data-qinjie/2021-CoRL.pdf) / [website](https://sites.google.com/u.northwestern.edu/roboflow)
...
5. **ICRA 2020** - Collision-free Navigation of Human-centered Robots via Markov Games  
   ...
   [paper](data-qinjie/2020-ICRA.pdf) / [video](https://www.youtube.com/watch?v=lFlo7tiD1fI) / [code](https://github.com/QinjieLin-NU/carl_server)
...
<div style="display: flex; align-items: flex-start; margin-bottom: 60px;">
  ...
  <div style="flex: 1;">
    ...
    <p style="font-size: 14px; margin-top: 5px; margin-bottom: 5px;">
      <a href="data-qinjie/2020-ICRA.pdf" style="text-decoration: underline;">paper</a> / 
...
<div style="display: flex; align-items: flex-start; margin-bottom: 60px;">
  ...
  <div style="flex: 1;">
    ...
    <p style="font-size: 14px; margin-top: 5px; margin-bottom: 5px;">
      <a href="data-qinjie/ICRA2023.pdf" style="text-decoration: underline;">paper</a> / 
...
<div style="display: flex; align-items: flex-start; margin-bottom: 60px;">
  ...
  <div style="flex: 1;">
    ...
    <p style="font-size: 14px; margin-top: 5px; margin-bottom: 5px;">
      <a href="data-qinjie/2021-CoRL.pdf" style="text-decoration: underline;">paper</a> / 
